...
- Run 441: Kommentarfeld ("Hinweis / Kommentar (optional)") von
  ...
  Grund", von Paco vorab abgesegnet). Eigener Branch/PR, unabhängig
  vom parallel laufenden Hilfe-Ton-PR (Run 440er-Serie) — beide
  beanspruchen aktuell Version 0.9.89, das muss beim Mergen der
  zweiten der beiden PRs kurz von Hand aufgelöst werden.
