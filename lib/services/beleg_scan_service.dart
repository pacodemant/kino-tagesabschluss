...
class BelegScanService {
  ...
  static const String _systemPrompt =
      ...
      '- Ist der Name einer Kartenart nicht vollständig lesbar, verdeckt\n'
      '  oder unklar: null für "art" setzen — Kartentyp niemals aus Layout,\n'
      '  Position oder Kontext erschließen oder vermuten.\n'
      '- Jeden Betrag ausschließlich der Kartenart zuordnen, die in derselben\n'
      '  Zeile/Position auf dem Beleg steht. Nicht anhand von Reihenfolge,\n'
      '  Erfahrungswerten oder Ähnlichkeit zu anderen Zeilen zuordnen — allein\n'
      '  die tatsächliche Zeilenposition auf dem Foto entscheidet, welcher\n'
      '  Betrag zu welcher Kartenart gehört.\n'
      ...
      '- gesamt_betrag_cent immer aus dem auf dem Beleg gedruckten\n'
      '  Gesamt-/Summenfeld ablesen, NIEMALS aus den einzelnen\n'
      '  zahlungsarten-Beträgen berechnen oder addieren — auch wenn beide\n'
      '  Werte übereinstimmen sollten.\n'
