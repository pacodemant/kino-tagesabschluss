...
class _TagesabschlussSchritt2SeiteState extends State<TagesabschlussSchritt2Seite> {
  ...
  void _ecBelegEntfernen(int index) {
    if (_ecBelegController.length <= 1 || index < 0 || index >= _ecBelegController.length) {
      return;
    }
    setState(() {
