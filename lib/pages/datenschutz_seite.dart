            ...
            ExpansionTile(
              ...
              children: const <Widget>[
                ...
                _DatenschutzAbschnitt(
                  ...
                  text:
                      'Wird der optionale BelegScan verwendet, wird das aufgenommene Belegfoto zur Auswertung an die Anthropic API (USA) übermittelt (rechtlich abgesichert über EU-Standardvertragsklauseln). An die Buchhaltung werden die ausgelesenen Zahlenwerte übergeben; das Belegfoto selbst wird zusätzlich an den kino-internen Server (Flurbocash) übertragen, um eine rechtskonforme Archivierung des Originalbelegs zu ermöglichen.',
                ),
