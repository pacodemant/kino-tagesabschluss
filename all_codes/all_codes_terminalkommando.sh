...
# all_codes/all_codes_snapshot.txt
#
...
# --------------------------------------------------
# Snapshot-Datei (im all_codes Ordner)
# --------------------------------------------------

mkdir -p all_codes
OUTPUT="all_codes/all_codes_snapshot.txt"
...
RUN_COUNTER_FILE="ai_prompt_templates/run_counter.txt"
